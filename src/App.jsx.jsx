...
const GMAPS_KEY=window.__GMAPS_KEY||"";
...
const MOCK_USERS=[
  {id:"u1",name:"Alex Chen",age:28,gender:"Male",fitnessLevel:"Intermediate",gym:"g1",verified:true,bio:"Looking for a consistent training partner for push/pull/legs. I train 5x a week, mornings preferred.",matchTime:"07:00",duration:90,workout:"Push Day",reliability:{completed:42,cancelledAdvance:3,noShows:0,score:97},longTerm:true,availability:{Mon:["morning"],Tue:["morning"],Wed:["morning"],Thu:["morning"],Fri:["morning"]}},
  ...
  {id:"u3",name:"Sam Taylor",age:31,gender:"Non-binary",fitnessLevel:"Beginner",gym:"g2",verified:true,bio:"Just getting started on my fitness journey. Looking for a patient buddy!",matchTime:"10:00",duration:60,workout:"Full Body",reliability:{completed:8,cancelledAdvance:1,noShows:0,score:95},longTerm:true,availability:{Tue:["morning"],Thu:["morning"],Sat:["morning","midday"]}},
  {id:"u4",name:"Morgan Lee",age:22,gender:"Male",fitnessLevel:"Intermediate",gym:"g1",verified:true,bio:"Leg day is the best day. Always down for a squat session. Consistency is key.",matchTime:"07:30",duration:60,workout:"Legs & Abs",reliability:{completed:31,cancelledAdvance:2,noShows:0,score:96},longTerm:true,availability:{Mon:["early","morning"],Wed:["morning"],Fri:["morning"],Sat:["midday"]}},
  ...
  {id:"u6",name:"Taylor Brooks",age:30,gender:"Male",fitnessLevel:"Intermediate",gym:"g1",verified:true,bio:"Morning gym crew. Let's build a routine together.",matchTime:"06:30",duration:60,workout:"Back & Biceps",reliability:{completed:20,cancelledAdvance:1,noShows:0,score:98},longTerm:true,availability:{Mon:["early"],Wed:["early"],Fri:["early","morning"]}},
  {id:"u7",name:"Riley Park",age:26,gender:"Female",fitnessLevel:"Beginner",gym:"g1",verified:true,bio:"New to weight training. Looking for a supportive partner.",matchTime:"17:30",duration:45,workout:"Legs & Glutes",reliability:{completed:5,cancelledAdvance:0,noShows:0,score:100},longTerm:true,availability:{Tue:["afternoon","evening"],Thu:["afternoon"]}},
